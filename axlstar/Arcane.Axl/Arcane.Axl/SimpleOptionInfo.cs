...
namespace Arcane.Axl
{
  ...
  public class SimpleOptionInfo : Option
  {
    ...
    : base(build_info)
    {
      ...
      if (m_type == "ustring")
      ...
      else if (m_type == "int16")
        m_etype = SimpleOptionInfoType.TypeInt16;
        ...
        m_etype = SimpleOptionInfoType.TypeInt16Array;
      else if (m_type == "int32[]")
        ...
        Console.WriteLine("** Les types reconnus sont 'ustring', 'string', 'real', "
                          + "'bool', 'integer', 'int16', 'int32', 'int64', 'real2', 'real3', 'real2x2', 'real3x3', "
                          + "'cstring', 'string[]', 'real[]',"
