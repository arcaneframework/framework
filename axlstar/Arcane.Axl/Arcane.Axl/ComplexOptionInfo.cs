...
namespace Arcane.Axl
{
  ...
  */
    ...
    : Option
  {
    ...
    {
      AcceptChildren (v, o => true);
    }

    public void AcceptChildren(IOptionInfoVisitor v, Func<Option,bool> predicate)
    {
    ...
    {
      AcceptChildrenSorted(v, lang, o => true);
    }
    
    public void AcceptChildrenSorted(IOptionInfoVisitor v,string lang, Func<Option,bool> predicate)
    {
