...
function(generateAxl target)
  ...
  foreach(axl_file ${axl})
    ...
    if(ARGS_AXL_OPTION_GENERATION_MODE STREQUAL "ALL")
      ...
      target_link_libraries(${target} PRIVATE axlstar_options)
    ...
    add_custom_command(
      ...
      DEPENDS ${file} ${AXLSTAR_AXL2CC_TARGETDEPEND}
      COMMAND ${AXLSTAR_AXL2CC}
      ARGS    ${header_args}
              ${copy_args}
              ${output_args}
              ${verbose_args}
    ...
    add_custom_target(_axl_${name} DEPENDS ${generated_files})
    add_dependencies(${target} _axl_${name})
