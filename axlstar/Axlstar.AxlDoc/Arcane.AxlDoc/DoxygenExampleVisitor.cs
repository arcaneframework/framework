...
namespace Arcane.AxlDoc
{
   ...
   : IOptionInfoVisitor
  {
    ...
    public DoxygenExampleVisitor(DoxygenExampleFile doc_file, CodeInfo code_info, string lang, IApplicationPages private_app_pages)
    {
    ...
    public void VisitComplex(ComplexOptionInfo option)
    {
      ...
      if (m_level <= 1) {
        ...
        option.AcceptChildren(dv, x => m_private_app_pages.Filter(x));
