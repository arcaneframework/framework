# Tutorial C++ API {#aliendoc_tutorials_tutorialcpp}
...
The Space concept enable to modelize the mathematical algebraic real space \f$R^N\f$ of dimension \f$N\f$
...
The Vector concept represents the set of unknowns \f$x=(x_i)\f$ element of a linear space \f$S_X\f$.
...
A linear system is represented by a matrix \f$A\f$, and two vectors \f$B\f$ and \f$X\f$ where \f$B\f$ is the system right hand side and \f$X\f$ the solution.
...
\ref aliendoc_tutorials
</span>
<span class="next_section_button">
\ref aliendoc_tutorials_tutorialc
</span>
</div>
