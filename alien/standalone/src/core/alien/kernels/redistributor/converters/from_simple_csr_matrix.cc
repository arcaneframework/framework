...
SimpleCSRtoRedistributorMatrixConverter::SimpleCSRtoRedistributorMatrixConverter() {}

SimpleCSRtoRedistributorMatrixConverter::~SimpleCSRtoRedistributorMatrixConverter() {}

BackEndId
SimpleCSRtoRedistributorMatrixConverter::sourceBackend() const
{
  return AlgebraTraits<BackEnd::tag::simplecsr>::name();
}

BackEndId
SimpleCSRtoRedistributorMatrixConverter::targetBackend() const
{
...
const IMatrixImpl* sourceImpl, IMatrixImpl* targetImpl) const
{
  ...
  alien_debug([&] {
    cout() << "Converting SimpleCSRMatrix: " << &src << " to Redistributor " << &tgt;
  });
