...
class SimpleCSRtoRedistributorMatrixConverter : public IMatrixConverter
{
 public:
  typedef SimpleCSRMatrix<Real> SrcMatrix;
  typedef RedistributorMatrix TgtMatrix;

 public:
  SimpleCSRtoRedistributorMatrixConverter();
  virtual ~SimpleCSRtoRedistributorMatrixConverter();
