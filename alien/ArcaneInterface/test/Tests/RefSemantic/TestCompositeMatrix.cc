...
{
  Alien::MatrixDistribution dist0(4, 4, Environment::parallelMng());
  Alien::MatrixDistribution dist1(5, 5, Environment::parallelMng());
  Alien::CompositeMatrix v(2);
  Alien::CompositeElement(v, 0, 0) = Alien::Matrix(4, 4, Environment::parallelMng());
  Alien::CompositeElement(v, 0, 1) = Alien::Matrix(4, 5, Environment::parallelMng());
  Alien::CompositeElement(v, 1, 0) = Alien::Matrix(5, 4, Environment::parallelMng());
  Alien::CompositeElement(v, 1, 1) = Alien::Matrix(5, 5, Environment::parallelMng());
...
TEST(TestCompositeMatrix, TimeStampTest)
{
  ...
  v.resize(2);
  Alien::CompositeElement(v, 0, 0) = Alien::Matrix(4, 4, Environment::parallelMng());
  Alien::CompositeElement(v, 0, 1) = Alien::Matrix(4, 4, Environment::parallelMng());
  Alien::CompositeElement(v, 1, 0) = Alien::Matrix(4, 4, Environment::parallelMng());
  Alien::CompositeElement(v, 1, 1) = Alien::Matrix(4, 4, Environment::parallelMng());
  ASSERT_EQ(0, impl->timestamp());
  std::cout << "main ts = " << impl->timestamp() << std::endl;
  auto& c0 = v(0, 0);
  auto* impl0 = c0.impl();
