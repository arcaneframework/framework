...
#include "ArcaneParallelEngine.h"
/*---------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------*/
...
namespace Alien
{
  ...
  ParallelEngine::ParallelEngine(Arcane::Accelerator::RunQueue& queue)
  : m_queue(queue)
  {
    m_internal.reset(new Internal::EngineInternal()) ;
  }
  ...
  std::size_t  ParallelEngine::maxNumThreads() const {
