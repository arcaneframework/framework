...
: public ParallelMngContainerBase
{
 ...
 public:
  ...
  SharedMemoryMachineMemoryWindowBaseCreator* m_window_creator = nullptr;
...
build()
{
  ...
  m_window_creator = new SharedMemoryMachineMemoryWindowBaseCreator(m_nb_local_rank, m_thread_barrier);
}
