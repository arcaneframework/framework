...
{
 public:
  MpiBlockVariableSynchronizeDispatcherBuildInfo(MpiParallelMng* pm, GroupIndexTable* table, Int32 block_size)
  : m_parallel_mng(pm), m_table(table), m_block_size(block_size) { }
 public:
