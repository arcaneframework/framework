...
class ParallelLoopOptions
{
 ...
 public:
  ...
  ParallelLoopOptions()
  : m_grain_size(AbstractItemRangeFunctor::DEFAULT_GRAIN_SIZE),
 ...
 * \ingroup Concurrency
 */
class ARCANE_CORE_EXPORT TaskContext
{
 public:
 ...
 * \ingroup Concurrency
 */
class ARCANE_CORE_EXPORT ITaskFunctor
{
 public:
 ...
 */
class ARCANE_CORE_EXPORT ITask
{
 ...
 */
class ARCANE_CORE_EXPORT ITaskImplementation
{
 public:
 ...
 * \ingroup Concurrency
 */
class ARCANE_CORE_EXPORT TaskFactory
{
 private:
  TaskFactory();
 public:
