                 ...
                 AlephParams* solver_param)
{
  ...
  case TypesSolver::BiCGStab2:
    KSPSetType(m_ksp_solver, KSPIBCGS);
    break;
    // Generalized Minimal Residual method. (Saad and Schultz, 1986) with restart
  case TypesSolver::GMRES:
    KSPSetType(m_ksp_solver, KSPGMRES);
    break;
  default:
    throw ArgumentException("AlephMatrixPETSc::AlephMatrixSolve", "Unknown solver method");
  }
  ...
  case TypesSolver::AINV:
    throw ArgumentException("AlephMatrixPETSc", "preconditionnement AINV indisponible");
  case TypesSolver::SPAIdyn:
    throw ArgumentException("AlephMatrixPETSc", "preconditionnement SPAIdyn indisponible");
  case TypesSolver::ILUp:
    throw ArgumentException("AlephMatrixPETSc", "preconditionnement ILUp indisponible");
  case TypesSolver::POLY:
    throw ArgumentException("AlephMatrixPETSc", "preconditionnement POLY indisponible");
  default:
    throw ArgumentException("AlephMatrixPETSc", "preconditionnement inconnu");
  }
  ...
  case (KSP_DIVERGED_NULL): {
    throw Exception("AlephMatrixPETSc::Solve", "KSP_DIVERGED_NULL");
  }
  case (KSP_DIVERGED_ITS): {
    throw Exception("AlephMatrixPETSc::Solve", "KSP_DIVERGED_ITS");
  }
  case (KSP_DIVERGED_DTOL): {
    throw Exception("AlephMatrixPETSc::Solve", "KSP_DIVERGED_DTOL");
  }
  case (KSP_DIVERGED_BREAKDOWN): {
    throw Exception("AlephMatrixPETSc::Solve", "KSP_DIVERGED_BREAKDOWN");
  }
  case (KSP_DIVERGED_BREAKDOWN_BICG): {
    throw Exception("AlephMatrixPETSc::Solve", "KSP_DIVERGED_BREAKDOWN_BICG");
  }
  case (KSP_DIVERGED_NONSYMMETRIC): {
    throw Exception("AlephMatrixPETSc::Solve", "KSP_DIVERGED_NONSYMMETRIC");
  }
  case (KSP_DIVERGED_INDEFINITE_PC): {
    throw Exception("AlephMatrixPETSc::Solve", "KSP_DIVERGED_INDEFINITE_PC");
  }
#if PETSC_VERSION_GE(3, 6, 1)
  case (KSP_DIVERGED_NANORINF): {
    throw Exception("AlephMatrixPETSc::Solve", "KSP_DIVERGED_NANORINF");
  }
#else
  case (KSP_DIVERGED_NAN): {
    throw Exception("AlephMatrixPETSc::Solve", "KSP_DIVERGED_NAN");
  }
#endif
  case (KSP_DIVERGED_INDEFINITE_MAT): {
    throw Exception("AlephMatrixPETSc::Solve", "KSP_DIVERGED_INDEFINITE_MAT");
  }
  ...
  default:
    throw Exception("AlephMatrixPETSc::Solve", "");
  }
