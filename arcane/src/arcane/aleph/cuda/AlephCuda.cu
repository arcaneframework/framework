 ...
 ****************************************************************************/
void Cuda::
convert_matrix(const CNC_Matrix& rhs, CNC_MatrixCRS<double>& A, bool separate_diag)
{
 ...
 ****************************************************************************/
void Cuda::
cnc_cuda_set_dim_vec_from_n(long N)
{
 ...
 *****************************************************************************/
void Cuda::
cublas_get_error(cublasStatus_t st)
{
