...
//-----------------------------------------------------------------------------
/*---------------------------------------------------------------------------*/
/* MeshVariableInfo.h                                          (C) 2000-2009 */
/*                                                                           */
/* Informations génériques pour les variables du maillage.                   */
/*---------------------------------------------------------------------------*/
#ifndef ARCANE_MESHVARIABLEINFO_H
#define ARCANE_MESHVARIABLEINFO_H
/*---------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------*/
...
template<>
class MeshVariableInfoT<DualNode,Real,0>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableScalarRefT<DualNode,Real> RefType;
  //! Type de la partie privé de la variable
  typedef VariableArrayT< Real > PrivateType;
};
template<>
class MeshVariableInfoT<DualNode,Real,1>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableArrayRefT<DualNode,Real> RefType;
  //! Type de la partie privé de la variable
  typedef Array2VariableT< Real > PrivateType;
};
template<>
class MeshVariableInfoT<DualNode,Real2,0>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableScalarRefT<DualNode,Real2> RefType;
  //! Type de la partie privé de la variable
  typedef VariableArrayT< Real2 > PrivateType;
};
template<>
class MeshVariableInfoT<DualNode,Real2,1>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableArrayRefT<DualNode,Real2> RefType;
  //! Type de la partie privé de la variable
  typedef Array2VariableT< Real2 > PrivateType;
};
template<>
class MeshVariableInfoT<DualNode,Real2x2,0>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableScalarRefT<DualNode,Real2x2> RefType;
  //! Type de la partie privé de la variable
  typedef VariableArrayT< Real2x2 > PrivateType;
};
template<>
class MeshVariableInfoT<DualNode,Real2x2,1>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableArrayRefT<DualNode,Real2x2> RefType;
  //! Type de la partie privé de la variable
  typedef Array2VariableT< Real2x2 > PrivateType;
};
template<>
class MeshVariableInfoT<DualNode,Real3,0>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableScalarRefT<DualNode,Real3> RefType;
  //! Type de la partie privé de la variable
  typedef VariableArrayT< Real3 > PrivateType;
};
template<>
class MeshVariableInfoT<DualNode,Real3,1>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableArrayRefT<DualNode,Real3> RefType;
  //! Type de la partie privé de la variable
  typedef Array2VariableT< Real3 > PrivateType;
};
template<>
class MeshVariableInfoT<DualNode,Real3x3,0>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableScalarRefT<DualNode,Real3x3> RefType;
  //! Type de la partie privé de la variable
  typedef VariableArrayT< Real3x3 > PrivateType;
};
template<>
class MeshVariableInfoT<DualNode,Real3x3,1>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableArrayRefT<DualNode,Real3x3> RefType;
  //! Type de la partie privé de la variable
  typedef Array2VariableT< Real3x3 > PrivateType;
};
template<>
class MeshVariableInfoT<DualNode,Int32,0>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableScalarRefT<DualNode,Int32> RefType;
  //! Type de la partie privé de la variable
  typedef VariableArrayT< Int32 > PrivateType;
};
template<>
class MeshVariableInfoT<DualNode,Int32,1>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableArrayRefT<DualNode,Int32> RefType;
  //! Type de la partie privé de la variable
  typedef Array2VariableT< Int32 > PrivateType;
};
template<>
class MeshVariableInfoT<DualNode,Int64,0>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableScalarRefT<DualNode,Int64> RefType;
  //! Type de la partie privé de la variable
  typedef VariableArrayT< Int64 > PrivateType;
};
template<>
class MeshVariableInfoT<DualNode,Int64,1>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableArrayRefT<DualNode,Int64> RefType;
  //! Type de la partie privé de la variable
  typedef Array2VariableT< Int64 > PrivateType;
};
...
template<>
class MeshVariableInfoT<Link,Real,0>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableScalarRefT<Link,Real> RefType;
  //! Type de la partie privé de la variable
  typedef VariableArrayT< Real > PrivateType;
};
template<>
class MeshVariableInfoT<Link,Real,1>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableArrayRefT<Link,Real> RefType;
  //! Type de la partie privé de la variable
  typedef Array2VariableT< Real > PrivateType;
};
template<>
class MeshVariableInfoT<Link,Real2,0>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableScalarRefT<Link,Real2> RefType;
  //! Type de la partie privé de la variable
  typedef VariableArrayT< Real2 > PrivateType;
};
template<>
class MeshVariableInfoT<Link,Real2,1>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableArrayRefT<Link,Real2> RefType;
  //! Type de la partie privé de la variable
  typedef Array2VariableT< Real2 > PrivateType;
};
template<>
class MeshVariableInfoT<Link,Real2x2,0>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableScalarRefT<Link,Real2x2> RefType;
  //! Type de la partie privé de la variable
  typedef VariableArrayT< Real2x2 > PrivateType;
};
template<>
class MeshVariableInfoT<Link,Real2x2,1>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableArrayRefT<Link,Real2x2> RefType;
  //! Type de la partie privé de la variable
  typedef Array2VariableT< Real2x2 > PrivateType;
};
template<>
class MeshVariableInfoT<Link,Real3,0>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableScalarRefT<Link,Real3> RefType;
  //! Type de la partie privé de la variable
  typedef VariableArrayT< Real3 > PrivateType;
};
template<>
class MeshVariableInfoT<Link,Real3,1>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableArrayRefT<Link,Real3> RefType;
  //! Type de la partie privé de la variable
  typedef Array2VariableT< Real3 > PrivateType;
};
template<>
class MeshVariableInfoT<Link,Real3x3,0>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableScalarRefT<Link,Real3x3> RefType;
  //! Type de la partie privé de la variable
  typedef VariableArrayT< Real3x3 > PrivateType;
};
template<>
class MeshVariableInfoT<Link,Real3x3,1>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableArrayRefT<Link,Real3x3> RefType;
  //! Type de la partie privé de la variable
  typedef Array2VariableT< Real3x3 > PrivateType;
};
template<>
class MeshVariableInfoT<Link,Int32,0>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableScalarRefT<Link,Int32> RefType;
  //! Type de la partie privé de la variable
  typedef VariableArrayT< Int32 > PrivateType;
};
template<>
class MeshVariableInfoT<Link,Int32,1>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableArrayRefT<Link,Int32> RefType;
  //! Type de la partie privé de la variable
  typedef Array2VariableT< Int32 > PrivateType;
};
template<>
class MeshVariableInfoT<Link,Int64,0>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableScalarRefT<Link,Int64> RefType;
  //! Type de la partie privé de la variable
  typedef VariableArrayT< Int64 > PrivateType;
};
template<>
class MeshVariableInfoT<Link,Int64,1>
{
 public:
  //! Type de la référence  la variable
  typedef MeshVariableArrayRefT<Link,Int64> RefType;
  //! Type de la partie privé de la variable
  typedef Array2VariableT< Int64 > PrivateType;
};
