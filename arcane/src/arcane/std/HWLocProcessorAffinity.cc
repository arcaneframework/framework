...
//-----------------------------------------------------------------------------
/*---------------------------------------------------------------------------*/
/* HWLocProcessorAffinity.cc                                   (C) 2000-2018 */
/*                                                                           */
...
, public IProcessorAffinityService
{
 public:
  ...
  : AbstractService(sbi) , m_is_init(false), m_topology(hwloc_topology_t())
  {
  }
 ...
 private:
  ...
  void _checkInit();
  void _outputTopology(hwloc_obj_t l,hwloc_obj_t parent,
...
_checkInit()
{
  ...
  info() << "Getting hardware architecture.";
...
printInfos()
{
  _checkInit();
  OStringStream ostrf;
  _outputTopology (hwloc_get_root_obj(m_topology), NULL, 0,ostrf);
  info() << ostrf.str();
...
int HWLocProcessorAffinityService::
...
/******************************************************************************
 * \brief Returns the number of Processing Unit, or (Logical) Processor
 * \return -1 on error
 ******************************************************************************/
