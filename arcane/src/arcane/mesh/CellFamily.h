...
, public IItemFamilyModifier
{
  ...
  typedef ItemConnectivitySelectorT<HParentCompactIncrementalItemConnectivity,IncrementalItemConnectivity> HParentConnectivity;
  typedef ItemConnectivitySelectorT<HChildCompactIncrementalItemConnectivity,IncrementalItemConnectivity> HChildConnectivity;
 public:
