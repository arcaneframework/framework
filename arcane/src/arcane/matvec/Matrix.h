...
//-----------------------------------------------------------------------------
/*---------------------------------------------------------------------------*/
/* Matrix.h                                                    (C) 2000-2007 */
/*                                                                           */
/* Matrix d'algèbre linéraire.                                               */
/*---------------------------------------------------------------------------*/
#ifndef ARCANE_MATVEC_MATRIX_H
...
class ARCANE_CORE_EXPORT ConjugateGradientSolver
{
 public:
  ...
  : m_nb_iteration(0), m_residual_norm(0.0),
...
{
 public:
  AMGPreconditioner(ITraceMng* tm) : m_trace_mng(tm), m_amg(0) {}
...
{
 public:
  AMGSolver(ITraceMng* tm) : m_trace_mng(tm), m_amg(0) {}
  virtual ~AMGSolver();
 public:
  virtual void build(const Matrix& matrix);
 public:
