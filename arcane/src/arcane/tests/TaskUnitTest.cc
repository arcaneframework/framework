 ...
 */
  class Test5Fibonnaci
  {
   public:
    ...
    Test5Fibonnaci(long n_, long* sum_)
    : n(n_)
    , sum(sum_)
    {}
...
executeTest()
{
  ...
  {
    TaskTest::Test6 t6(traceMng(), 50, 1000);
    t6.exec();
  }
  {
    TaskTest::Test6 t6(traceMng(), 0, 1500);
    t6.exec();
  }
  {
    TaskTest::Test6 t6(traceMng(), 0, 32000);
    t6.exec();
  }
  {
    TaskTest::Test6 t6(traceMng(), 0, 32000, 500);
    t6.exec();
  }
  {
    TaskTest::Test6 t6(traceMng(), 127, 1329);
    t6.exec();
  }
  {
    TaskTest::Test6 t6(traceMng(), 47, 721, 0);
    t6.exec();
  }
  {
    TaskTest::Test6 t6(traceMng(), 1023, 4097, 50);
    t6.exec();
  }
  {
    TaskTest::Test6 t6(traceMng(), 0, 4000, 100);
    t6.exec();
  }
  {
    TaskTest::Test6 t6(traceMng(), 0, 200000, 2000);
    t6.exec();
  }
}
