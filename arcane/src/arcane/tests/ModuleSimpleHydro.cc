...
Real SimpleHydroModuleBase::getDeltatInit()
{
  return m_options->deltatInit();
}
TypesSimpleHydro::eViscosity SimpleHydroModuleBase::getViscosity()
{
  return m_options->viscosity();
}
Real SimpleHydroModuleBase::getViscosityLinearCoef()
{
  return m_options->viscosityLinearCoef();
}
Real SimpleHydroModuleBase::getViscosityQuadraticCoef()
{
  return m_options->viscosityQuadraticCoef();
}
ConstArrayView<IBoundaryCondition*> SimpleHydroModuleBase::getBoundaryConditions()
{
  return m_options->getBoundaryCondition();
}
Real SimpleHydroModuleBase::getCfl()
{
  return m_options->cfl();
}
Real SimpleHydroModuleBase::getVariationSup()
{
  return m_options->variationSup();
}
Real SimpleHydroModuleBase::getVariationInf()
{
  return m_options->variationInf();
}
Real SimpleHydroModuleBase::getDensityGlobalRatio()
{
  return m_options->densityGlobalRatio();
}
Real SimpleHydroModuleBase::getDeltatMax()
{
  return m_options->deltatMax();
}
Real SimpleHydroModuleBase::getDeltatMin()
{
  return m_options->deltatMin();
}
Real SimpleHydroModuleBase::getFinalTime()
{
  return m_options->finalTime();
}
Integer SimpleHydroModuleBase::getBackwardIteration()
{
  return m_options->backwardIteration();
}
bool SimpleHydroModuleBase::isCheckNumericalResult()
{
  return m_options->checkNumericalResult();
}
