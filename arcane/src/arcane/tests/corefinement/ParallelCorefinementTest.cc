...
#include "arcane/tests/corefinement/ParallelCorefinementTestion.h"
#include "arcane/corefinement/IParallelCorefinement.h"
...
class ParallelCorefinementTest : public ArcaneParallelCorefinementTestObject
{
 public:
...
class Tester
{
 ...
 public:
  ...
  Tester(ParallelCorefinementTest* _m, IGeometry* _geometry)
  : m(_m)
  , geometry(_geometry)
  {}
  void run(const ISurfaceUtils::FaceFaceContactList& contacts, const Integer testid, const String testname)
  {
    ...
    __normals[0] = AsumXYZ.x;
    __normals[1] = AsumXYZ.y;
    __normals[2] = AsumXYZ.z;
    __normals[3] = BsumXYZ.x;
    __normals[4] = BsumXYZ.y;
    __normals[5] = BsumXYZ.z;
    m->subDomain()->parallelMng()->reduce(Parallel::ReduceSum, __normals);
    AsumXYZ.x = __normals[0];
    AsumXYZ.y = __normals[1];
    AsumXYZ.z = __normals[2];
    BsumXYZ.x = __normals[3];
    BsumXYZ.y = __normals[4];
    BsumXYZ.z = __normals[5];
...
executeTest()
{
  ...
  __normals[0] = normalA_coref.x;
  __normals[1] = normalA_coref.y;
  __normals[2] = normalA_coref.z;
  __normals[3] = normalA_local.x;
  __normals[4] = normalA_local.y;
  __normals[5] = normalA_local.z;
  __normals[6] = normalB_coref.x;
  __normals[7] = normalB_coref.y;
  __normals[8] = normalB_coref.z;
  __normals[9] = normalB_local.x;
  __normals[10] = normalB_local.y;
  __normals[11] = normalB_local.z;
  subDomain()->parallelMng()->reduce(Parallel::ReduceSum, __normals);
  normalA_coref.x = __normals[0];
  normalA_coref.y = __normals[1];
  normalA_coref.z = __normals[2];
  normalA_local.x = __normals[3];
  normalA_local.y = __normals[4];
  normalA_local.z = __normals[5];
  normalB_coref.x = __normals[6];
  normalB_coref.y = __normals[7];
  normalB_coref.z = __normals[8];
  normalB_local.x = __normals[9];
  normalB_local.y = __normals[10];
  normalB_local.z = __normals[11];
