...
//-----------------------------------------------------------------------------
/*---------------------------------------------------------------------------*/
/* IMeshPartitionConstraint.h                                  (C) 2000-2017 */
/*                                                                           */
/* Interface d'une contrainte de partitionnement d'un maillage.              */
/*---------------------------------------------------------------------------*/
#ifndef ARCANE_IMESHPARTITIONCONSTRAINT_H
#define ARCANE_IMESHPARTITIONCONSTRAINT_H
/*---------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------*/
...
class IMeshPartitionConstraint
{
 public:
  ...
  virtual ~IMeshPartitionConstraint() {} //<! Libère les ressources
