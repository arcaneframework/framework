...
fillSubZoneQuad4(Quad4ElementView sub_zone, Integer i)
{
  switch (i) {
  case 0:
    sub_zone.init(node(0), face(0), center(), face(3));
    break;
  case 1:
    sub_zone.init(node(1), face(1), center(), face(0));
    break;
  case 2:
    sub_zone.init(node(2), face(2), center(), face(1));
    break;
  case 3:
    sub_zone.init(node(3), face(3), center(), face(2));
    break;
  }
}
...
fillSubZoneTriangle3(Quad4ElementView sub_zone, Integer i)
{
  switch (i) {
  case 0:
    sub_zone.init(node(0), face(0), center(), node(0));
    break;
  case 1:
    sub_zone.init(node(1), face(1), center(), face(0));
    break;
  case 2:
    ...
    break;
  case 3:
    sub_zone.init(node(0), node(0), center(), face(2));
    break;
  }
}
...
fillSubZoneHexaedron8(HexaElementView sub_zone, Integer i)
{
  switch (i) {
  case 0:
    sub_zone.init(node(0), edge(0), face(0), edge(3), edge(4), face(2), center(), face(1));
    break;
  case 1:
    sub_zone.init(node(1), edge(1), face(0), edge(0), edge(5), face(4), center(), face(2));
    break;
  case 2:
    sub_zone.init(node(2), edge(2), face(0), edge(1), edge(6), face(5), center(), face(4));
    break;
  case 3:
    sub_zone.init(node(3), edge(3), face(0), edge(2), edge(7), face(1), center(), face(5));
    break;
  case 4:
    sub_zone.init(node(4), edge(11), face(3), edge(8), edge(4), face(1), center(), face(2));
    break;
  case 5:
    sub_zone.init(node(5), edge(8), face(3), edge(9), edge(5), face(2), center(), face(4));
    break;
  case 6:
    sub_zone.init(node(6), edge(9), face(3), edge(10), edge(6), face(4), center(), face(5));
    break;
  case 7:
    sub_zone.init(node(7), edge(10), face(3), edge(11), edge(7), face(5), center(), face(1));
    break;
  }
}
...
fillSubZonePyramid5(HexaElementView sub_zone, Integer i)
{
  ...
  case 0:
    ...
    break;
  case 1:
    sub_zone.init(node(1), edge(1), face(0), edge(0), edge(5), face(3), center(), face(2));
    break;
  case 2:
    sub_zone.init(node(2), edge(2), face(0), edge(1), edge(6), face(4), center(), face(3));
    break;
  case 3:
    sub_zone.init(node(3), edge(3), face(0), edge(2), edge(7), face(1), center(), face(4));
    break;
  case 4:
    sub_zone.init(node(4), node(4), node(4), node(4), edge(4), face(1), center(), face(2));
    break;
  case 5:
    sub_zone.init(node(4), node(4), node(4), node(4), edge(5), face(2), center(), face(3));
    break;
  case 6:
    sub_zone.init(node(4), node(4), node(4), node(4), edge(6), face(3), center(), face(4));
    break;
  case 7:
    sub_zone.init(node(4), node(4), node(4), node(4), edge(7), face(4), center(), face(1));
    break;
  }
}
...
fillSubZonePentaedron6(HexaElementView sub_zone, Integer i)
{
  switch (i) {
  case 0:
    sub_zone.init(node(0), edge(0), face(0), edge(2), edge(3), face(2), center(), face(1));
    break;
  case 1:
    sub_zone.init(node(1), edge(1), face(0), edge(0), edge(4), face(4), center(), face(2));
    break;
  case 2:
    sub_zone.init(node(2), edge(2), face(0), edge(1), edge(5), face(1), center(), face(4));
    break;
  case 3:
    sub_zone.init(node(3), edge(8), face(3), edge(6), edge(3), face(1), center(), face(2));
    break;
  case 4:
    sub_zone.init(node(4), edge(6), face(3), edge(7), edge(4), face(2), center(), face(4));
    break;
  case 5:
    sub_zone.init(node(5), edge(7), face(3), edge(8), edge(5), face(4), center(), face(1));
    break;
  }
}
...
fillSubZoneTetraedron4(HexaElementView sub_zone, Integer i)
{
  ...
  case 0:
    ...
    break;
  case 1:
    sub_zone.init(node(1), edge(1), face(0), edge(0), edge(4), face(3), center(), face(2));
    break;
  case 2:
    sub_zone.init(node(2), edge(2), face(0), edge(1), edge(5), face(1), center(), face(3));
    break;
  case 3:
    sub_zone.init(node(3), edge(3), face(1), edge(5), edge(4), face(2), center(), face(3));
    break;
  }
}
...
fillSubZoneHeptaedron10(HexaElementView sub_zone, Integer i)
{
  switch (i) {
  case 0:
    sub_zone.init(node(0), edge(0), face(0), edge(4), edge(10), face(2), center(), face(6));
    break;
  case 1:
    sub_zone.init(node(1), edge(1), face(0), edge(0), edge(11), face(3), center(), face(2));
    break;
  case 2:
    sub_zone.init(node(2), edge(2), face(0), edge(1), edge(12), face(4), center(), face(3));
    break;
  case 3:
    sub_zone.init(node(3), edge(3), face(0), edge(2), edge(13), face(5), center(), face(4));
    break;
  case 4:
    sub_zone.init(node(4), edge(4), face(0), edge(3), edge(14), face(6), center(), face(5));
    break;
  case 5:
    sub_zone.init(node(5), edge(9), face(1), edge(5), edge(10), face(6), center(), face(2));
    break;
  case 6:
    sub_zone.init(node(6), edge(5), face(1), edge(6), edge(11), face(2), center(), face(3));
    break;
  case 7:
    sub_zone.init(node(7), edge(6), face(1), edge(7), edge(12), face(3), center(), face(4));
    break;
  case 8:
    sub_zone.init(node(8), edge(7), face(1), edge(8), edge(13), face(4), center(), face(5));
    break;
  case 9:
    sub_zone.init(node(9), edge(8), face(1), edge(9), edge(14), face(5), center(), face(6));
    break;
  }
}
...
fillSubZoneOctaedron12(HexaElementView sub_zone, Integer i)
{
  switch (i) {
  case 0:
    sub_zone.init(node(0), edge(0), face(0), edge(5), edge(12), face(2), center(), face(7));
    break;
  case 1:
    sub_zone.init(node(1), edge(1), face(0), edge(0), edge(13), face(3), center(), face(2));
    break;
  case 2:
    sub_zone.init(node(2), edge(2), face(0), edge(1), edge(14), face(4), center(), face(3));
    break;
  case 3:
    sub_zone.init(node(3), edge(3), face(0), edge(2), edge(15), face(5), center(), face(4));
    break;
  case 4:
    sub_zone.init(node(4), edge(4), face(0), edge(3), edge(16), face(6), center(), face(5));
    break;
  case 5:
    sub_zone.init(node(5), edge(5), face(0), edge(4), edge(17), face(7), center(), face(6));
    break;
  case 6:
    sub_zone.init(node(6), edge(11), face(1), edge(6), edge(12), face(7), center(), face(2));
    break;
  case 7:
    sub_zone.init(node(7), edge(6), face(1), edge(7), edge(13), face(2), center(), face(3));
    break;
  case 8:
    sub_zone.init(node(8), edge(7), face(1), edge(8), edge(14), face(3), center(), face(4));
    break;
  case 9:
    sub_zone.init(node(9), edge(8), face(1), edge(9), edge(15), face(4), center(), face(5));
    break;
  case 10:
    sub_zone.init(node(10), edge(9), face(1), edge(10), edge(16), face(5), center(), face(6));
    break;
  case 11:
    sub_zone.init(node(11), edge(10), face(1), edge(11), edge(17), face(6), center(), face(7));
    break;
  }
}
