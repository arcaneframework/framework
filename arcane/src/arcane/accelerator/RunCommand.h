...
/*---------------------------------------------------------------------------*/
#ifndef ARCANE_ACCELERATOR_RUNCOMMAND_H
#define ARCANE_ACCELERATOR_RUNCOMMAND_H
/*---------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------*/
 ...
 */
class ARCANE_ACCELERATOR_EXPORT RunCommand
{
 ...
 public:
  ...
  friend ARCANE_ACCELERATOR_EXPORT RunCommand& operator<<(RunCommand& command,const TraceInfo& trace_info);
  void resetInfos();
