...
/*---------------------------------------------------------------------------*/
#ifndef ARCANE_ACCELERATOR_CORE_INTERNAL_ACCELERATORMEMORYALLOCATORBASE_H
#define ARCANE_ACCELERATOR_CORE_INTERNAL_ACCELERATORMEMORYALLOCATORBASE_H
/*---------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------*/
 ...
 */
class ARCANE_ACCELERATOR_CORE_EXPORT BlockAllocatorWrapper
{
 public:
 ...
 */
class ARCANE_ACCELERATOR_CORE_EXPORT AcceleratorMemoryAllocatorBase
