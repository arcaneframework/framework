...
: public Item
{
 ...
 public:
  ...
  //! un seul parent
  Node hParent() const { return Node(_hParentBase(0)); }
  ...
  //! i-ème enfant AMR
  Node hChild(Int32 i) const { return Node(_hChildBase(i)); }

  //! parent de niveau 0 pour l'AMR
  Node topHParent() const { return Node(_toItemBase().topHParentBase()); }
   ...
   * m_internal->hChild(rank) serait iitem;
   */
  Int32 whichChildAmI(NodeLocalId local_id) const
  {
...
: public ItemWithNodes
{
 ...
 public:
  ...
  //! dans un premier temps, les appelations, pour l'amr, sont en français i.e. parent -> pere et child -> enfant
  //! un seul parent
  Face hParent() const { return Face(_hParentBase(0)); }
  ...
  //! i-ème enfant AMR
  Face hChild(Int32 i) const { return Face(_hChildBase(i)); }

  //! parent de niveau 0 pour l'AMR
  Face topHParent() const { return Face(_toItemBase().topHParentBase()); }
   ...
   * m_internal->hChild(rank) serait iitem;
   */
  Int32 whichChildAmI(FaceLocalId local_id) const
  {
    return _toItemBase().whichChildAmI(local_id);
  }
};
