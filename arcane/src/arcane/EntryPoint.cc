...
const char* const IEntryPoint::WComputeLoop = "ComputeLoop";
const char* const IEntryPoint::WBuild = "Build";
const char* const IEntryPoint::WInit = "Init";
const char* const IEntryPoint::WContinueInit = "ContinueInit";
const char* const IEntryPoint::WStartInit = "StartInit";
const char* const IEntryPoint::WRestore = "Restore";
const char* const IEntryPoint::WOnMeshChanged = "OnMeshChanged";
const char* const IEntryPoint::WOnMeshRefinement = "OnMeshRefinement";
const char* const IEntryPoint::WExit = "Exit";
