...
, public ICartesianMeshAMRPatchMng
{
 ...
 public:
  ...
  void flagCellToRefine(ConstArrayView<Int32> cells_lids, bool clear_old_flags) override;
  void flagCellToCoarsen(ConstArrayView<Int32> cells_lids, bool clear_old_flags) override;
