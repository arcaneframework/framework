...
//-----------------------------------------------------------------------------
/*---------------------------------------------------------------------------*/
/* IParallelNonBlockingCollective.h                            (C) 2000-2015 */
/*                                                                           */
/* Interface des opérations parallèles collectives non bloquantes.           */
/*---------------------------------------------------------------------------*/
#ifndef ARCANE_IPARALLELNONBLOCKINGCOLLECTIVE_H
#define ARCANE_IPARALLELNONBLOCKINGCOLLECTIVE_H
/*---------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------*/
...
class ARCANE_CORE_EXPORT IParallelNonBlockingCollective
{
 public:
  ...
  virtual ~IParallelNonBlockingCollective() {} //!< Libère les ressources.
