...
//-----------------------------------------------------------------------------
/*---------------------------------------------------------------------------*/
/* DataTypeContainer.h                                         (C) 2000-2018 */
/*                                                                           */
/* Conteneur contenant une instance d'une classe par type de donnÃ©e.         */
/*---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*/
/*!
 * \brief Conteneur contenant une instance d'une classe par type de donnÃ©e.
 *
 ...
 * \endcode
 *
 * La mÃ©thode instance() permet de rÃ©cupÃ©rer une rÃ©fÃ©rence sur l'instance
 * Ã  partir de son type.
 */
