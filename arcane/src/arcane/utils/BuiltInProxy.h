...
template <typename Type> Type BuiltInProxy<Type>::getValue() const
{
  m_info.setRead();
  return m_value;
}

template <typename Type> inline bool operator==(const BuiltInProxy<Type>& a, const BuiltInProxy<Type>& b)
{
  return a.getValue() == b.getValue();
}
template <typename Type> inline bool operator==(const BuiltInProxy<Type>& a, const Type& b)
{
  return a.getValue() == b;
}
template <typename Type> inline bool operator==(const Type& a, const BuiltInProxy<Type>& b)
{
  return a == b.getValue();
}
