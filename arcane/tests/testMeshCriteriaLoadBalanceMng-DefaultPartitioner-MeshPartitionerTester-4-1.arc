...
<case codename="ArcaneTest" xml:lang="en" codeversion="1.0">
  <arcane>
    ...
    <description>Test MeshCriteriaLoadBalanceMng avec le partitionneur par défaut et le partitionneur test (Variant 1 / 4 proc)</description>
  ...
  <mesh-criteria-load-balance-mng-test>
    <mesh-params>
      <partitioner>DefaultPartitioner</partitioner>
