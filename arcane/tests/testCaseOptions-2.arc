...
<cas codename="ArcaneTest" xml:lang="fr" codeversion="1.0">
 <arcane>
  ...
  <description>Test jeu de données avec unités</description>
 ...
 <case-options-tester>
  ...
  <simple-real>3.0</simple-real>
  <simple-real-unit unit="cm">4.2</simple-real-unit>
  <simple-real-unit2 unit="km" fonction="test-time-real">0.0</simple-real-unit2>
  <simple-realarray-unit unit="mm">2.2 2.3 0.1 3.5</simple-realarray-unit>
