...
<cas codename="ArcaneTest" xml:lang="fr" codeversion="1.0">
  <arcane>
  <titre>CartesianMeshGeneratorOrigin</titre>
  <description>Test de la generation de maillages cartesiens avec changement d'origine</description>
