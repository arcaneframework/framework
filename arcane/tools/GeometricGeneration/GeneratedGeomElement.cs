...
namespace GeometricGeneration {
    ...
    public partial class GeneratedGeomElement : GeneratedGeomElementBase {
 ...
 foreach( Item item in Connectivity.Items2DAnd3D ) { 
            ...
            this.Write("\n/*!\n * \\ingroup ArcaneGeometric\n * \\brief Eléments géométriques de type GeomType::");
            ...
            this.Write("ElementView ViewType;\n public:\n   using GeomElementBase< ");
            ...
            this.Write("Element(const VariableNodeReal3& coords,ItemWithNodes item) : GeomElementBase(coords,item){}\n  ");
            ...
            this.Write("Element(Real3ConstArrayView coords) : GeomElementBase(coords){}\n  ");
 ...
 if (item.BasicName != item.Name ) { 
            ...
            this.Write("//! Elément géométrique de type GeomType::");
    ...
    public class GeneratedGeomElementBase {
