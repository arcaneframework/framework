...
namespace Arcane
{
  ...
  {  
    ...
    public static implicit operator ArrayView<Int16>(Int16ArrayView v)
    {
      return new ArrayView<Int16>(v.m_ptr,v.m_size);
    }

    //! Opérateur de conversion vers la version template
    public static implicit operator ConstArrayView<Int16>(Int16ArrayView v)
    {
      return new ConstArrayView<Int16>(v.m_ptr,v.m_size);
    }
  ...
  {  
    ...
    //! Opérateur de conversion vers la version template
    public static implicit operator ConstArrayView<Int16>(Int16ConstArrayView v)
    {
      return new ConstArrayView<Int16>(v.m_ptr,v.m_size);
    }
