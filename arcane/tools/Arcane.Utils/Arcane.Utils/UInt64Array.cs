...
namespace Arcane
{
  ...
  {  
    ...
    public static implicit operator ArrayView<UInt64>(UInt64ArrayView v)
    {
      return new ArrayView<UInt64>(v.m_ptr,v.m_size);
    }

    //! Opérateur de conversion vers la version template
    public static implicit operator ConstArrayView<UInt64>(UInt64ArrayView v)
    {
      return new ConstArrayView<UInt64>(v.m_ptr,v.m_size);
    }
  ...
  {  
    ...
    //! Opérateur de conversion vers la version template
    public static implicit operator ConstArrayView<UInt64>(UInt64ConstArrayView v)
    {
      return new ConstArrayView<UInt64>(v.m_ptr,v.m_size);
    }
