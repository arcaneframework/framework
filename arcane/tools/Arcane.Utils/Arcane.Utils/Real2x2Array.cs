...
namespace Arcane
{
  ...
  {  
    ...
    public static implicit operator ArrayView<Real2x2>(Real2x2ArrayView v)
    {
      return new ArrayView<Real2x2>(v.m_ptr,v.m_size);
    }

    //! Opérateur de conversion vers la version template
    public static implicit operator ConstArrayView<Real2x2>(Real2x2ArrayView v)
    {
      return new ConstArrayView<Real2x2>(v.m_ptr,v.m_size);
    }
  ...
  {  
    ...
    //! Opérateur de conversion vers la version template
    public static implicit operator ConstArrayView<Real2x2>(Real2x2ConstArrayView v)
    {
      return new ConstArrayView<Real2x2>(v.m_ptr,v.m_size);
    }
