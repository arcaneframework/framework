...
namespace Arcane
{
  ...
  {  
    ...
    public static implicit operator ArrayView<Int64>(Int64ArrayView v)
    {
      return new ArrayView<Int64>(v.m_ptr,v.m_size);
    }

    //! Opérateur de conversion vers la version template
    public static implicit operator ConstArrayView<Int64>(Int64ArrayView v)
    {
      return new ConstArrayView<Int64>(v.m_ptr,v.m_size);
    }
  ...
  {  
    ...
    //! Opérateur de conversion vers la version template
    public static implicit operator ConstArrayView<Int64>(Int64ConstArrayView v)
    {
      return new ConstArrayView<Int64>(v.m_ptr,v.m_size);
    }
