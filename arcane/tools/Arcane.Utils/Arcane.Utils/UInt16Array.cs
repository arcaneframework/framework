...
namespace Arcane
{
  ...
  {  
    ...
    public static implicit operator ArrayView<UInt16>(UInt16ArrayView v)
    {
      return new ArrayView<UInt16>(v.m_ptr,v.m_size);
    }

    //! Opérateur de conversion vers la version template
    public static implicit operator ConstArrayView<UInt16>(UInt16ArrayView v)
    {
      return new ConstArrayView<UInt16>(v.m_ptr,v.m_size);
    }
  ...
  {  
    ...
    //! Opérateur de conversion vers la version template
    public static implicit operator ConstArrayView<UInt16>(UInt16ConstArrayView v)
    {
      return new ConstArrayView<UInt16>(v.m_ptr,v.m_size);
    }
