Le support des tests unitaires dans Arcane {#arcanedoc_user_unit_tests}
==========================================

[TOC]

## Introduction {#arcanedoc_user_unit_tests_intro}
...
## Déclaration des tests {#arcanedoc_user_unit_tests_decl}
...
## Les assertions {#arcanedoc_user_unit_tests_assertions}
...
### Tests unitaires en parallèle {#arcanedoc_user_unit_tests_parallel}
...
### Cas particulier des exceptions {#arcanedoc_user_unit_tests_exception} 
...
arcanedoc_traces). Cette méthode lève une exception de type
Arcane::FatalErrorException qu'il suffit de traiter comme dans
l'exemple ci-dessus.

## Le fichier de données {#arcanedoc_user_unit_tests_data}
...
## L'exécution {#arcanedoc_user_unit_tests_run}
...
## Utiliser sa propre boucle en temps {#arcanedoc_user_unit_tests_own_timeloop}
