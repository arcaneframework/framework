...
\b %Element. Par exemple, pour les héxaèdres, le nom est Hexaedron8Element.
...
hexa[5] = Real3(1.2,0.0,0.0); // Change la valeur du 6ème sommet
Real3 z = hexa[4]; // Récupère la valeur du 5ème sommet
```
...
GeomShapeView. Si on connait le type exacte, il faut utiliser la vue
...
* opérations qui prennent le même nombre de coorodonnées mais qui
