 ...
 */
class ARCANE_MATERIALS_EXPORT MeshMaterialVariableRef
{
 public:
  class Enumerator
  {
...
: public MeshMaterialVariableRef
{
 ...
 public:
  ...
  ARCANE_MATERIALS_EXPORT CellMaterialVariableScalarRef(const VariableBuildInfo& vb);
  //! Construit une référence à la variable spécifiée dans \a vb
  ARCANE_MATERIALS_EXPORT CellMaterialVariableScalarRef(const MaterialVariableBuildInfo& vb);
  ARCANE_MATERIALS_EXPORT CellMaterialVariableScalarRef(const CellMaterialVariableScalarRef<DataType>& rhs);

 private:

  //! Opérateur de recopie (interdit)
  ARCANE_MATERIALS_EXPORT void operator=(const CellMaterialVariableScalarRef<DataType>& rhs);
 ...
 public:
  ...
  ARCANE_MATERIALS_EXPORT virtual void refersTo(const CellMaterialVariableScalarRef<DataType>& rhs);

  /*!
   * \internal
   */
  ARCANE_MATERIALS_EXPORT virtual void updateFromInternal();
 ...
 public:
   ...
   */
  ARCANE_MATERIALS_EXPORT DataType matValue(AllEnvCell c,Int32 mat_id) const;

  /*!
   * \brief Valeur de la variable pour le milieu d'index \a env_id de
   * la maille \a ou 0 si absent de la maille.
   */
  ARCANE_MATERIALS_EXPORT DataType envValue(AllEnvCell c,Int32 env_id) const;
 ...
 public:
  ...
  ARCANE_MATERIALS_EXPORT void fillToArray(IMeshMaterial* mat,Array<DataType>& values);
  ARCANE_MATERIALS_EXPORT void fillToArray(IMeshMaterial* mat,Array<DataType>& values,Int32ConstArrayView indexes);
  ARCANE_MATERIALS_EXPORT void fill(const DataType& value);
  ARCANE_MATERIALS_EXPORT void fillPartialValues(const DataType& value);

 public:

  //! Variable globale associée à cette variable matériau
  ARCANE_MATERIALS_EXPORT GlobalVariableRefType& globalVariable();
  //! Variable globale associée à cette variable matériau
  ARCANE_MATERIALS_EXPORT const GlobalVariableRefType& globalVariable() const;
...
: public MeshMaterialVariableRef
{
 ...
 public:
  ...
  ARCANE_MATERIALS_EXPORT CellMaterialVariableArrayRef(const VariableBuildInfo& vb);
  //! Construit une référence à la variable spécifiée dans \a vb
  ARCANE_MATERIALS_EXPORT CellMaterialVariableArrayRef(const MaterialVariableBuildInfo& vb);
  ARCANE_MATERIALS_EXPORT CellMaterialVariableArrayRef(const CellMaterialVariableArrayRef<DataType>& rhs);

 private:

  //! Opérateur de recopie (interdit)
  ARCANE_MATERIALS_EXPORT void operator=(const CellMaterialVariableArrayRef<DataType>& rhs);
  //! Constructeur vide (interdit)
 ...
 public:
  ...
  //! Positionne la référence de l'instance à la variable \a rhs.
  ARCANE_MATERIALS_EXPORT virtual void refersTo(const CellMaterialVariableArrayRef<DataType>& rhs);
