...
//-----------------------------------------------------------------------------
/*---------------------------------------------------------------------------*/
/* MeshEnvironmentVariableRef.h                                (C) 2000-2016 */
/*                                                                           */
...
: public MeshMaterialVariableRef
{
 ...
 public:
  ...
  ARCANE_MATERIALS_EXPORT CellEnvironmentVariableScalarRef(const VariableBuildInfo& vb);
  //! Construit une référence à la variable spécifiée dans \a vb
  ARCANE_MATERIALS_EXPORT CellEnvironmentVariableScalarRef(const MaterialVariableBuildInfo& vb);
  ARCANE_MATERIALS_EXPORT CellEnvironmentVariableScalarRef(const CellEnvironmentVariableScalarRef<DataType>& rhs);

 private:

  //! Opérateur de recopie (interdit)
  ARCANE_MATERIALS_EXPORT void operator=(const CellEnvironmentVariableScalarRef<DataType>& rhs);
 ...
 public:
  ...
  ARCANE_MATERIALS_EXPORT virtual void refersTo(const CellEnvironmentVariableScalarRef<DataType>& rhs);
...
: public MeshMaterialVariableRef
{
 ...
 public:
  ...
  ARCANE_MATERIALS_EXPORT CellEnvironmentVariableArrayRef(const VariableBuildInfo& vb);
  //! Construit une référence à la variable spécifiée dans \a vb
  ARCANE_MATERIALS_EXPORT CellEnvironmentVariableArrayRef(const MaterialVariableBuildInfo& vb);
  ARCANE_MATERIALS_EXPORT CellEnvironmentVariableArrayRef(const CellEnvironmentVariableArrayRef<DataType>& rhs);

 private:

  //! Opérateur de recopie (interdit)
  ARCANE_MATERIALS_EXPORT void operator=(const CellEnvironmentVariableArrayRef<DataType>& rhs);
  //! Constructeur vide (interdit)
 ...
 public:
  ...
  //! Positionne la référence de l'instance à la variable \a rhs.
  ARCANE_MATERIALS_EXPORT virtual void refersTo(const CellEnvironmentVariableArrayRef<DataType>& rhs);
