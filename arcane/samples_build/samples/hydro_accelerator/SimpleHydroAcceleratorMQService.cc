...
applyBoundaryCondition()
{
  ...
  for( auto bc : m_boundary_conditions ){
    ...
    ax::RunQueue& used_queue = *(bc.queue_ref.get());
...
ARCANE_REGISTER_SERVICE(SimpleHydroAcceleratorMQService,
                        ServiceProperty("SimpleHydroAcceleratorMQService",ST_SubDomain),
