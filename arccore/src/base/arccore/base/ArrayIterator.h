...
class ArrayIterator
{
 ...
 public:
  ...
  constexpr ARCCORE_HOST_DEVICE ArrayIterator& operator++() ARCCORE_NOEXCEPT
  {
    ++m_ptr;
    return *this;
  }
  ...
  constexpr ARCCORE_HOST_DEVICE ArrayIterator& operator+=(difference_type n) ARCCORE_NOEXCEPT
  {
    m_ptr += n;
    return *this;
  }
