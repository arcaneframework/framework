# Compilation et installation d'Arcane

- [Compilation et installation d'Arcane](#compilation-et-installation-darcane)
  - [Prérequis](#prérequis)
    - [Ubuntu 22.04](#ubuntu-2204)
    - [Ubuntu 20.04](#ubuntu-2004)
      - [CMake](#cmake)
      - [Environnement `.Net`](#environnement-net)
    - [Arch Linux/Manjaro via Pacman/YAY](#arch-linuxmanjaro-via-pacmanyay)
- [Compilation](#compilation)
  - [Gestion des packages externes utilisés par Arcane](#gestion-des-packages-externes-utilisés-par-arcane)
