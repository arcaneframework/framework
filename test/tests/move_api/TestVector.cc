...
//{
//  const Alien::VectorData v(10, AlienTest::Environment::parallelMng());
//  ASSERT_TRUE(Alien::Space(10) == v.space());
//  ASSERT_EQ(10, v.space().size());
//}
//
...
//{
//  const Alien::VectorData v(std::move(Alien::VectorData(10, AlienTest::Environment::parallelMng())));
//  ASSERT_TRUE(Alien::Space(10) == v.space());
//  ASSERT_EQ(10, v.space().size());
//}
//
...
//{
//  auto v = Alien::VectorData(10, AlienTest::Environment::parallelMng());
//  ASSERT_TRUE(Alien::Space(10) == v.space());
//  ASSERT_EQ(10, v.space().size());
//  v = Alien::VectorData(5, AlienTest::Environment::parallelMng());
