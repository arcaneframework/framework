...
class AlienTestModule : public ArcaneAlienTestObject
{
 ...
 private:
  ...
  void buildAndFillInBlockVector(Alien::Vector& vectorB, const double& value);

  void buildAndFillInBlockVector(Alien::Vector& vectorB,
  ...
  Alien::SolverStatus solve(Alien::ILinearSolver* solver, Alien::Matrix& matrixA,
      Alien::Vector& vectorB, Alien::Vector& vectorX,
      AlienTestOptionTypes::eBuilderType builderType);

  void vectorVariableUpdate(
      Alien::Vector& vectorB, Alien::ArcaneTools::IIndexManager::Entry indexSetU);
