...
{
public:
  C(const A& a ALIEN_UNUSED_PARAM) : value(-1.) {}
  C(const B& b ALIEN_UNUSED_PARAM) : value(-1.) {}
  C(const A& a ALIEN_UNUSED_PARAM, const B& b ALIEN_UNUSED_PARAM) : value(-1.) {}
  C(const B& b ALIEN_UNUSED_PARAM, const A& a ALIEN_UNUSED_PARAM) : value(-1.) {}
  ~C() {}
  double value;
};
