...
class AlienStokesModule :
    public ArcaneAlienStokesObject
{
 public:
  //! Constructor
...
public:
  ...
  bool solveUzawaMethod(Alien::Matrix& A,
                        Alien::Matrix& B,
                        Alien::Matrix& tB,
                        Alien::Vector& f,
                        Alien::Vector& g,
...
private :
  ...
  void _computeFaceConnectivity(Face const& face, Alien::UniqueArray2<Integer>& connectivity) ;
