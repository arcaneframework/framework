...
class ARCCORE_BASE_EXPORT BasicTranscoder
{
 ...
 public:
  ...
  static void transcodeFromUtf16ToISO88591(ConstSpan<UChar> utf16,std::string& s);

  static void transcodeFromISO88591ToUtf8(const char* str,Int64 len,CoreArray<Byte>& utf8);
  static void transcodeFromUtf8ToISO88591(ConstSpan<Byte> utf8,std::string& s);

  static void transcodeFromUtf16ToUtf8(ConstSpan<UChar> utf16,CoreArray<Byte>& utf8);
  static void transcodeFromUtf8ToUtf16(ConstSpan<Byte> utf8,CoreArray<UChar>& utf16);
  ...
  static void substring(CoreArray<Byte>& utf8,ConstSpan<Byte> rhs,Int64 pos,Int64 len);
};
