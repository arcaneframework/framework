...
message(STATUS "Warning: using obsolete FindMPI")
...
if(MPI_FOUND)
  ...
  # Avec les version récentes de CMake (3.8+), il faut utiliser MPIEXEC_EXECUTABLE
  if(MPIEXEC_EXECUTABLE)
    set(MPI_EXEC ${MPIEXEC_EXECUTABLE})
  else()
...
if(MPI_FOUND AND NOT TARGET mpi)
  ...
  foreach (MPI_DEF ${MPI_CXX_DEFINITIONS})
	    ...
	    # Ne fonctionne qu'avec lkes générateurs Makefile et Ninja
