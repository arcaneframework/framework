# Comment écrire de la documentation {#sampledoc_doxygen}

[TOC]

## Introduction {#sampledoc_doxygen_intro}
...
## Structure {#sampledoc_doxygen_struct}
...
```md
# Débuter avec %Sample {#sampledoc_getting_started}

Vous débutez sur %Sample ? Ce chapitre devrait vous donner les notions de bases.

Sommaire de ce chapitre :
1. \subpage sampledoc_getting_started_about
2. \subpage sampledoc_getting_started_basicstruct
...
\ref sampledoc_getting_started_about
</span>
</div>
```
...
```md
# Qu'est-ce que %Sample ? {#sampledoc_getting_started_about}

[TOC]

## Arcon, Arccore ?  {#sampledoc_getting_started_about_arcall}
### Arcon  {#sampledoc_getting_started_about_arcall_arcon}

...Texte...

## Framework ?  {#sampledoc_getting_started_about_framework}
...
\ref sampledoc_getting_started
</span>
<span class="next_section_button">
\ref sampledoc_getting_started_basicstruct
</span>
</div>
```
...
`sample`\_`nom_du_chapitre`\_`nom_de_la_page`.
...
`sample`\_`nom_du_chapitre`\_`nom_de_la_page`\_`titre_de_la_section_niveau2`\_`titre_de_la_section_niveau3`,...
...
```md
# Exemple concret {#sampledoc_examples_concret_example}


Ce sous-chapitre présente un exemple concret appelé `Quicksilver %Arcane Mini-App`.

Il est recommandé d'avoir lu le sous-chapitre précédent \ref sampledoc_examples_simple_example
pour bien comprendre ce qui suit, car certaines choses ne seront pas répétées ici.

Sommaire de ce sous-chapitre :
1. \subpage sampledoc_examples_concret_example_struct
...
<div class="section_buttons">
<span class="back_section_button">
\ref sampledoc_examples
</span>
<span class="next_section_button">
\ref sampledoc_examples_concret_example_struct
</span>
</div>
```

Les tag seront structurés comme ça :
`sample`\_`nom_du_chapitre`\_`nom_du_sous_chapitre`\_`nom_de_la_page`\_`titre_de_la_section_niveau2`,...
