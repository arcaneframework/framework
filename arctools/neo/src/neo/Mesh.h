...
class Mesh
{
 ...
 public:
  ...
  static std::string removedTargetItemIndexfilteredItemPropertyName(std::string const& connectivity_name) {
    return  "RemovedTargetItemIndexProperty" + connectivity_name;
  }
