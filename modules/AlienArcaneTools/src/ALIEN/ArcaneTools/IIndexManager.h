...
class IIndexManager
{
 ...
 public:
  ...
  // 0;
  // virtual ScalarIndexSet buildScalarIndexSet(const String name, const Arcane::ItemGroup
  // & itemGroup) = 0;
  ...
  // virtual VectorIndexSet buildVectorIndexSet(const String name, const Arcane::ItemGroup
 ...
 public:
   ...
   *  usuellement dans le desctructeur des implémentations extérieures de IAbstractFamily
   */
