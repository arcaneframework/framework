...
template class ALIEN_EXTERNALPACKAGES_EXPORT LinearSolver<BackEnd::tag::tpetraserial>;
#ifdef KOKKOS_ENABLE_OPENMP
template class ALIEN_EXTERNALPACKAGES_EXPORT LinearSolver<BackEnd::tag::tpetraomp>;
#endif
#ifdef KOKKOS_ENABLE_THREADS
template class ALIEN_EXTERNALPACKAGES_EXPORT LinearSolver<BackEnd::tag::tpetrapth>;
#endif
/*---------------------------------------------------------------------------*/
