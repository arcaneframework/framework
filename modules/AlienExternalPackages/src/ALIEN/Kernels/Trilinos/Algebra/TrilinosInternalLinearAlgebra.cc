...
/*---------------------------------------------------------------------------*/
template class ALIEN_EXTERNALPACKAGES_EXPORT LinearAlgebra<BackEnd::tag::tpetraserial>;
...
template class ALIEN_EXTERNALPACKAGES_EXPORT LinearAlgebra<BackEnd::tag::tpetraomp> ;
...
template class ALIEN_EXTERNALPACKAGES_EXPORT LinearAlgebra<BackEnd::tag::tpetrapth> ;
