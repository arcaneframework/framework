...
class ALIEN_EXTERNALPACKAGES_EXPORT SLEPcInternalEigenSolver
...
, public ObjectWithTrace
{
 ...
 public:
  ...
  SLEPcInternalEigenSolver(Arccore::MessagePassing::IMessagePassingMng* parallel_mng = nullptr, IOptionsSLEPcEigenSolver* options = nullptr);
 ...
 public:
  ...
  template<typename VectorT>
  bool solve(Alien::GeneralizedEigenProblemT<Alien::BackEnd::tag::petsc,VectorT>& problem);
 ...
 private:
  ...
  int _solve(Arccore::Integer local_size,PETScMatrix const& A,
           std::vector<double>& r_eigen_values,
           std::vector<double>& i_eigen_values,
...
#ifdef ALIEN_USE_SLEPC
template<typename VectorT>
bool SLEPcInternalEigenSolver::solve(Alien::EigenProblemT<Alien::BackEnd::tag::petsc,VectorT>& problem)
{
...
template<typename VectorT>
bool SLEPcInternalEigenSolver::solve(Alien::GeneralizedEigenProblemT<Alien::BackEnd::tag::petsc,VectorT>& problem)
{
  ...
  SLEPcStatus status ;
  _solve(local_size,A,B,real_eigen_values,imaginary_eigen_values,eigen_vectors,status) ;
