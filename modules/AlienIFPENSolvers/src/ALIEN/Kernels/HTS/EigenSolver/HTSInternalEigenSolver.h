...
class ALIEN_IFPENSOLVERS_EXPORT HTSInternalEigenSolver
  ...
  public ObjectWithTrace
{
 ...
 public:
  ...
  HTSInternalEigenSolver(Arccore::MessagePassing::IMessagePassingMng* parallel_mng = nullptr, IOptionsHTSEigenSolver* options = nullptr);
 ...
 public:
  ...
  template<typename VectorT>
  bool solve(Alien::GeneralizedEigenProblemT<Alien::BackEnd::tag::simplecsr,VectorT>& problem);
...
template<typename VectorT>
bool HTSInternalEigenSolver::solve(Alien::EigenProblemT<Alien::BackEnd::tag::simplecsr,VectorT>& problem)
{
  ...
  m_hts_solver->solveEigenProblem(hts_A,
                                   real_eigen_values,
                                   imaginary_eigen_values,
                                   eigen_vectors,
                                   status,
                                   context) ;
...
template<typename VectorT>
bool HTSInternalEigenSolver::solve(Alien::GeneralizedEigenProblemT<Alien::BackEnd::tag::simplecsr,VectorT>& problem)
{
  using namespace HartsSolver ;
  ...
  HartsSolver::HTSSolver::Status status ;
  HartsSolver::HTSSolver::ContextType& context = m_hts_solver->getContext(m_current_ctx_id) ;
  m_hts_solver->solveGeneralizedEigenProblem(hts_A,hts_B,
                                             real_eigen_values,
                                             imaginary_eigen_values,
                                             eigen_vectors,
                                             status,
