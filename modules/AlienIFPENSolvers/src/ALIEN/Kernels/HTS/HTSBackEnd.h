...
extern IInternalLinearAlgebra<HTSMatrix<Arccore::Real>, SimpleCSRVector<Arccore::Real>>*
...
template<>
struct AlgebraTraits<BackEnd::tag::htssolver>
{
...
template<>
struct AlgebraTraits<BackEnd::tag::hts>
{
  typedef HTSMatrix<Arccore::Real>       matrix_type;
  typedef SimpleCSRVector<Arccore::Real> vector_type;
  typedef IInternalLinearAlgebra<matrix_type, vector_type> algebra_type;
