...
public:
    ...
    AlienTestModule(const Arcane::ModuleBuildInfo &mbi)
            : ArcaneAlienTestObject(mbi), m_uniform(m_generator) {}
...
private:
    ...
    void buildAndFillInBlockVector(Alien::VectorData &vectorB, ConstArrayView<Integer> allXIndex,
                                   ConstArrayView<Real> value);

    void buildAndFillInBlockVector(Alien::VectorData &vectorB, ConstArrayView<Integer> allUIndex,
                                   ConstArray2View<Integer> allPIndex, ConstArrayView<Integer> allXIndex,
                                   ConstArrayView<Real> value);
