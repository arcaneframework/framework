...
const std::string TrilinosInternal::Node<BackEnd::tag::tpetracuda>::execution_space_name = "Cuda";
#endif
...
std::string TrilinosInternal::getEnv<std::string>(std::string const& key,std::string default_value)
{
  ...
  return default_value ;
        ...
        void TrilinosInternal::initialize(Arccore::MessagePassing::IMessagePassingMng *parallel_mng,
