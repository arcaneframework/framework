...
class MatrixInternal
{
 public:
  ...
  typedef HPDDM::Schwarz<SUBDOMAIN,
                         COARSEOPERATOR,
                         'S',
                         ValueT>            HPDDMMatrixType ;
...
private :
  ...
  void _compute(HPDDMCSRMatrixType* matrix_dirichlet,
                HPDDMCSRMatrixType* matrix_neumann,
                unsigned short nu,
                bool schwarz_coarse_correction) ;
