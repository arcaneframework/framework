...
IFPInternalLinearSolverFactory(Arccore::MessagePassing::IMessagePassingMng* p_mng);
...
template<>
struct AlgebraTraits<BackEnd::tag::ifpsolver>
{
  ...
  */
  ...
  //static vector_type * createVector(const MultiVectorImpl * impl) { return new vector_type(impl); }
} ;
