...
HTSInternalEigenSolver::HTSInternalEigenSolver(
    Arccore::MessagePassing::IMessagePassingMng* parallel_mng, IOptionsHTSEigenSolver* options)
...
IEigenSolver*
HTSInternalEigenSolverFactory(Arccore::MessagePassing::IMessagePassingMng* p_mng, IOptionsHTSEigenSolver* options)
{
