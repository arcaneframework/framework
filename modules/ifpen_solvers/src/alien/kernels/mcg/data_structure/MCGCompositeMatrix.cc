...
bool
MCGCompositeMatrix::
initDiagMatrix(const int i,const int block_size,const int nrow,
...
bool
MCGCompositeMatrix::
initOffDiagMatrix(const int i,const int j,
      const int block_size,const int block_size2,
...
bool
MCGCompositeMatrix::
initOffDiagSymProfileMatrix(const int i,const int j,
                  const int block_size,const int block_size2,
                  const int nrow,const int ncol,const int *row_offset,const int *cols,
                  const bool trans)
{
...
bool
MCGCompositeMatrix::
_initMatrix(const int i,const int j,
      const int block_size,const int block_size2,
      const int nrow,const int ncol,const int *row_offset,const int *cols)
{
...
bool
MCGCompositeMatrix::
_initTransMatrix(const int i,const int j,
      const int block_size,const int block_size2,
      const int nrow,const int ncol,const int *row_offset,const int *cols)
{
  int nnz = row_offset[nrow];
...
bool
MCGCompositeMatrix::
initMatrixValues(const int i,const int j,Real const* values)
{
  assert(i<2);
  assert(j<2);
