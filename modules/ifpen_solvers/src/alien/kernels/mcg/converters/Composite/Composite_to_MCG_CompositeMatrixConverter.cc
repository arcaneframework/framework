...
public:
  ...
  BackEndId targetBackend() const { return AlgebraTraits<BackEnd::tag::mcgsolver_composite>::name(); }
  ...
  void _build(const SimpleCSRMatrix<Real> & sourceImpl, MCGCompositeMatrix & targetImpl) const;
  void _buildSubMatrix01(const SimpleCSRMatrix<Real> & sourceImpl, MCGCompositeMatrix & targetImpl) const;
  void _buildSubMatrix10(const SimpleCSRMatrix<Real> & sourceImpl, MCGCompositeMatrix & targetImpl) const;
  void _buildSubMatrix11(const SimpleCSRMatrix<Real> & sourceImpl, MCGCompositeMatrix & targetImpl) const;
};
...
void
Composite_to_MCG_MatrixConverter::
_build(const SimpleCSRMatrix<Real> & sourceImpl, MCGCompositeMatrix & targetImpl) const
{
...
void
Composite_to_MCG_MatrixConverter::
_buildSubMatrix01(const SimpleCSRMatrix<Real> & sourceImpl, MCGCompositeMatrix & targetImpl) const
{
...
void
Composite_to_MCG_MatrixConverter::
_buildSubMatrix10(const SimpleCSRMatrix<Real> & sourceImpl, MCGCompositeMatrix & targetImpl) const
{
  const MatrixDistribution& dist = sourceImpl.distribution();
  const CSRStructInfo & profile = sourceImpl.getCSRProfile();
  const SimpleCSRMatrix<Real>::MatrixInternal& matrixInternal = sourceImpl.internal();
...
void
Composite_to_MCG_MatrixConverter::
_buildSubMatrix11(const SimpleCSRMatrix<Real> & sourceImpl, MCGCompositeMatrix & targetImpl) const
{
  const CSRStructInfo & profile = sourceImpl.getCSRProfile();
  const Integer localSize = profile.getNRow();
