...
class ALIEN_EXTERNAL_PACKAGES_EXPORT TrilinosInternalLinearAlgebra
...
class ALIEN_EXTERNAL_PACKAGES_EXPORT TpetraOmpInternalLinearAlgebra
...
class ALIEN_EXTERNAL_PACKAGES_EXPORT TpetraPthInternalLinearAlgebra
