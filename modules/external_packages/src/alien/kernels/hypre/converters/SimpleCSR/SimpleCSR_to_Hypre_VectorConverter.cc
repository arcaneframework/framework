...
public:
  ...
  Alien::BackEndId targetBackend() const { return AlgebraTraits<BackEnd::tag::hypre>::name(); }
...
{
  const SimpleCSRVector<Arccore::Real> & v = cast<SimpleCSRVector<Arccore::Real> >(sourceImpl, sourceBackend());
