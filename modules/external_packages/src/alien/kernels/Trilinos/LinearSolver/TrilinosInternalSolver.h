...
#ifndef MODULES_EXTERNAL_PACKAGES_SRC_ALIEN_KERNELS_TRILINOS_LINEARSOLVER_TRILINOSINTERNALSOLVER_H_
#define MODULES_EXTERNAL_PACKAGES_SRC_ALIEN_KERNELS_TRILINOS_LINEARSOLVER_TRILINOSINTERNALSOLVER_H_
...
public :
  ...
  typedef Ifpack2::Preconditioner<scalar_type,
                                  ...
                                  global_ordinal_type,
                                  node_type>                 prec_type;
  typedef Belos::SolverManager<scalar_type,
                               vec_type,
                               op_type>                      solver_type;
...
public :
  ...
  void
  initPrecondParameters (IOptionsTrilinosSolver* options)
  {
    ...
    switch(options->preconditioner())
    {
      ...
      case TrilinosOptionTypes::Relaxation:
        ...
        {
          m_precond_parameters->set( "relaxation: type",          options->relaxation()[0]->type().localstr()) ;
          m_precond_parameters->set( "relaxation: sweeps",        options->relaxation()[0]->sweeps()) ;
          m_precond_parameters->set( "relaxation: damping factor",options->relaxation()[0]->dampingFactor()) ;
          m_precond_parameters->set( "relaxation: backward mode", options->relaxation()[0]->backwardMode()) ;
          m_precond_parameters->set( "relaxation: use l1",        options->relaxation()[0]->useL1()) ;
          m_precond_parameters->set( "relaxation: l1 eta",        options->relaxation()[0]->l1Eta()) ;
          m_precond_parameters->set( "relaxation: zero starting solution", options->relaxation()[0]->zeroStartingSolution()) ;
        }
        break ;
      case TrilinosOptionTypes::Chebyshev:
        ...
        if(options->chebyshev().size()>0)
        {
          ...
          m_precond_parameters->set( "chebyshev: min eigenvalue", options->chebyshev()[0]->minEigenvalue() );
          m_precond_parameters->set( "chebyshev: max eigenvalue", options->chebyshev()[0]->maxEigenvalue());
          m_precond_parameters->set( "chebyshev: ratio eigenvalue", options->chebyshev()[0]->ratioEigenvalue());
          m_precond_parameters->set( "chebyshev: eigenvalue max iterations", options->chebyshev()[0]->eigenvalueMaxIterations());
          m_precond_parameters->set( "chebyshev: boost factor", options->chebyshev()[0]->boostFactor());
          m_precond_parameters->set( "chebyshev: zero starting solution", options->chebyshev()[0]->zeroStartingSolution());
        }
        break ;
      case TrilinosOptionTypes::ILUK:
        ...
        {
          m_precond_parameters->set( "fact: iluk level-of-fill", options->iluk()[0]->levelOfFill() );
          m_precond_parameters->set( "fact: relax value",        options->iluk()[0]->relaxValue() );
          m_precond_parameters->set( "fact: absolute threshold", options->iluk()[0]->absoluteThreshold() );
          m_precond_parameters->set( "fact: relative threshold", options->iluk()[0]->relativeThreshold() );
        }
        break ;
      case TrilinosOptionTypes::ILUT:
        ...
        {
          m_precond_parameters->set( "fact: ilut level-of-fill", options->ilut()[0]->levelOfFill() );
          m_precond_parameters->set( "fact: drop tolerance",     options->ilut()[0]->dropTolerance() );
          m_precond_parameters->set( "fact: absolute threshold", options->ilut()[0]->absoluteThreshold() );
          m_precond_parameters->set( "fact: relative threshold", options->ilut()[0]->relativeThreshold() );
      ...
      case TrilinosOptionTypes::Schwarz:
        ...
        {
          m_precond_parameters->set("schwarz: subdomain solver name", options->schwarz()[0]->subdomainSolver().localstr()) ;
          m_precond_parameters->set("schwarz: combine mode"         , options->schwarz()[0]->combineMode().localstr()) ;
          m_precond_parameters->set("schwarz: num iterations"       , options->schwarz()[0]->numIterations()) ;
          if(options->schwarz()[0]->subdomainSolver()=="RELAXATION")
          {
            if(options->relaxation().size()>0)
            {
              ...
              plist.set( "relaxation: damping factor",options->relaxation()[0]->dampingFactor()) ;
              plist.set( "relaxation: backward mode", options->relaxation()[0]->backwardMode()) ;
          ...
          if(options->schwarz()[0]->subdomainSolver()=="ILUT")
          {
            if(options->ilut().size()>0)
            {
              ...
              plist.set( "fact: absolute threshold", options->ilut()[0]->absoluteThreshold() );
              plist.set( "fact: relative threshold", options->ilut()[0]->relativeThreshold() );
          ...
          if(options->schwarz()[0]->subdomainSolver()=="ILUK")
          {
            if(options->iluk().size()>0)
            {
              ...
              plist.set( "fact: absolute threshold", options->iluk()[0]->absoluteThreshold() );
              plist.set( "fact: relative threshold", options->iluk()[0]->relativeThreshold() );
              m_precond_parameters->set("schwarz: subdomain solver parameters",plist);
            }
          ...
          if(options->schwarz()[0]->subdomainSolver()=="CHEBYSHEV")
          {
            if(options->chebyshev().size()>0)
            {
              ...
              plist.set( "chebyshev: min eigenvalue",            options->chebyshev()[0]->minEigenvalue() );
              plist.set( "chebyshev: max eigenvalue",            options->chebyshev()[0]->maxEigenvalue());
              plist.set( "chebyshev: ratio eigenvalue",          options->chebyshev()[0]->ratioEigenvalue());
              plist.set( "chebyshev: eigenvalue max iterations", options->chebyshev()[0]->eigenvalueMaxIterations());
              plist.set( "chebyshev: boost factor",              options->chebyshev()[0]->boostFactor());
              plist.set( "chebyshev: zero starting solution",    options->chebyshev()[0]->zeroStartingSolution());
              m_precond_parameters->set("schwarz: subdomain solver parameters",plist);
            }
      ...
      case TrilinosOptionTypes::MueLuPC:
        ...
        {
          m_precond_parameters->set("verbosity",         options->muelu()[0]->verbosity().localstr());
          m_precond_parameters->set("max levels",        options->muelu()[0]->maxLevel());
          m_precond_parameters->set("cycle type",        options->muelu()[0]->cycleType().localstr());
          m_precond_parameters->set("problem: symmetric",options->muelu()[0]->symmetric() );
          if(options->muelu()[0]->xmlParameterFile().size()>0)
            m_precond_parameters->set("xml parameter file",  options->muelu()[0]->xmlParameterFile()[0].localstr());
          m_precond_parameters->set("smoother: type",     options->muelu()[0]->smootherType().localstr());
          ...
          m_precond_parameters->set("smoother: overlap",   options->muelu()[0]->smootherOverlap());

          m_precond_parameters->set("coarse: max size",    options->muelu()[0]->maxCoarseSize() );
          m_precond_parameters->set("coarse: type",        options->muelu()[0]->coarseType().localstr() );
          m_precond_parameters->set("coarse: overlap",     options->muelu()[0]->coarseOverlap());

          m_precond_parameters->set("aggregation: type",        options->muelu()[0]->aggregationType().localstr());
          //m_precond_parameters->set("aggregation: mode",        options->muelu()[0]->aggregationMode().localstr());
          m_precond_parameters->set("aggregation: ordering",    options->muelu()[0]->aggregationOrdering().localstr());
          m_precond_parameters->set("aggregation: drop scheme", options->muelu()[0]->aggregationDropScheme().localstr());
          m_precond_parameters->set("aggregation: drop tol",    options->muelu()[0]->aggregationDropTol());
          m_precond_parameters->set("aggregation: min agg size",options->muelu()[0]->aggregationMinAggSize());
          m_precond_parameters->set("aggregation: max agg size",options->muelu()[0]->aggregationMaxAggSize());
          m_precond_parameters->set("aggregation: Dirichlet threshold",options->muelu()[0]->aggregationDirichletThreshold());

          m_precond_parameters->set("multigrid algorithm", options->muelu()[0]->multigridAlgorithm().localstr());
          m_precond_parameters->set("sa: damping factor",  options->muelu()[0]->saDamplingFactor());
        }
        break;
      default :
        break ;
  ...
  void initSolverParameters(IOptionsTrilinosSolver* options)
  {
    ...
    m_solver_parameters->set ("Num Blocks", 40);
    m_solver_parameters->set ("Maximum Iterations", 400);
    m_solver_parameters->set ("Convergence Tolerance", 1.0e-8);
  }


  Teuchos::RCP<Tpetra::Operator<scalar_type,
                                local_ordinal_type,
                                global_ordinal_type,
                                node_type> >
                        ...
                        std::ostream& err)
  {
    ...
    err << "Creating preconditioner : " << precondType<<endl
        << "-- Configuring" << endl;
    //
    ...
    {
      typedef MueLu::TpetraOperator<scalar_type,
                                    local_ordinal_type,
                                    global_ordinal_type,
                                    node_type>                        prec_type ;
  ...
  Status
  solve (std::ostream& out, vec_type& X, const vec_type& B, const op_type& A, Teuchos::RCP<op_type> M)
  {
    using Teuchos::ParameterList;
    using Teuchos::parameterList;
    using Teuchos::RCP;
  ...
  Status solve(matrix_type& A, const vector_type& B, vector_type& X)
  {
    ...
    //Tpetra::MatrixMarket::Writer<matrix_type>::writeSparseFile("MatrixA.txt",A);

    // Compute the preconditioner using the matrix A.
    // The matrix A itself is not modified.
    RCP<op_type> M = createPreconditioner(A, m_precond_name,m_precond_parameters, std::cout, std::cerr);
...
#endif /* MODULES_EXTERNAL_PACKAGES_SRC_ALIEN_KERNELS_TRILINOS_LINEARSOLVER_TRILINOSINTERNALSOLVER_H_ */
