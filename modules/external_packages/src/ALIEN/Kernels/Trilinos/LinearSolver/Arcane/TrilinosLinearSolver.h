...
class ALIEN_EXTERNAL_PACKAGES_EXPORT TrilinosLinearSolver
  ...
  public LinearSolver<TagT>
{
 public:
  ...
  TrilinosLinearSolver(IParallelMng* parallel_mng, std::shared_ptr<IOptionsTrilinosSolver> _options);
