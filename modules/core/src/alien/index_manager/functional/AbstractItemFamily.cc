...
/*---------------------------------------------------------------------------*/
    ...
    AbstractItemFamily::AbstractItemFamily(const AbstractItemFamily &family)
            : m_parallel_mng(family.m_parallel_mng), m_trace_mng(family.m_trace_mng), m_unique_ids(family.m_unique_ids),
              m_owners(family.m_owners), m_uid2lid(family.m_uid2lid) {}
...
/*---------------------------------------------------------------------------*/
    AbstractItemFamily::AbstractItemFamily(const ConstArrayView<Int64> uniqueIds,
                                           ...
                                           ITraceMng *trace_mng)
            : m_parallel_mng(parallel_mng), m_trace_mng(trace_mng) {
