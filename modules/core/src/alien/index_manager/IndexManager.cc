...
/*---------------------------------------------------------------------------*/
    ...
    IndexManager::IndexManager(Alien::IMessagePassingMng *parallelMng, Alien::ITraceMng *traceMng)
            : m_parallel_mng(parallelMng), m_trace_mng(traceMng), m_local_owner(0), m_state(Undef), m_verbose(false),
              m_local_entry_count(0), m_global_entry_count(0), m_global_entry_offset(0), m_local_removed_entry_count(0),
              m_global_removed_entry_count(0), m_max_null_index_opt(false) {
        this->init();
    }
